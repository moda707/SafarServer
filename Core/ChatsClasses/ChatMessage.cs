...
namespace SafarCore.ChatsClasses
{
    public class ChatMessage
    {
        ...
        public static Task<List<ChatMessage>> GetChatMessages(string tripId, int startIndex = 0, int count = 20)
        {
            ...
            var chatList = dbConnection.GetFilteredListAsync<ChatMessage>(CollectionNames.Chats, filter, sort, count);
